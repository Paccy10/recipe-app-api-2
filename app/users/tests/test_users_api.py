...
class PublicUsersApiTests(TestCase):
    ...
    def test_create_token_for_user_succeeds(self):
    ...
    def test_create_token_with_blank_password_fails(self):
...
class PrivateUsersApiTests(TestCase):
    ...
    def test_retrieve_profile_succeeds(self):
    ...
    def test_post_me_not_allowed_fails(self):
