...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_new_tags_succeeds(self):
    ...
    def test_create_recipe_with_existing_tag_succeeds(self):
    ...
    def test_create_tag_on_update_recipe_succeeds(self):
    ...
    def test_update_recipe_assign_tag_succeeds(self):
    ...
    def test_clear_recipe_tags_succeeds(self):
    ...
    def test_create_recipe_with_new_ingredients_succeeds(self):
    ...
    def test_create_recipe_with_existing_ingredient_succeeds(self):
    ...
    def test_create_ingredient_on_update_recipe_succeeds(self):
    ...
    def test_update_recipe_assign_ingredient_succeeds(self):
    ...
    def test_clear_recipe_ingredients_succeeds(self):
    ...
    def test_filter_recipes_by_tags_succeeds(self):
    ...
    def test_filter_recipes_by_ingredients_succeeds(self):
